namespace elite_dangerous_colonise.Services
{
    ...
    public class AppLogger
    {
        ...
        /// <summary> Instantiates an AppLogger. </summary>
        /// <param name="logger">A configured Serilog ILogger service.</param>
        ...
        /// <param name="eventCategory"> The category of the event (usually the class where the message was logged). </param>
